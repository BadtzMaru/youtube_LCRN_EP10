	...
	function renderTrade() {
		return (
			<View
				...
				<View style={{ marginTop: SIZES.padding, marginBottom: SIZES.padding * 1.5, alignItems: 'center', justifyContent: 'center' }}>
					<Text style={{ ...FONTS.h2 }}>
						{selectedCurrency?.wallet.crypto} {selectedCurrency?.code}
					</Text>
					<Text style={{ color: COLORS.green, ...FONTS.body4 }}>${selectedCurrency?.wallet.value}</Text>
				</View>
